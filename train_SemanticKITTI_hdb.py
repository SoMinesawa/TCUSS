...
import numpy as np
import random
from datasets.SemanticKITTI_hdb import KITTItrain, cfl_collate_fn, cfl_collate_fn_temporal, KITTItemporal
import torch
...
from eval_SemanticKITTI_hdb import eval
...
def parse_args():
    ...
    parser.add_argument('--hdb', action='store_true', help='HDBSCAN')
