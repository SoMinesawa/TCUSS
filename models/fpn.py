...
class Res16FPNBase(ResNetBase):
    ...
    def network_initialization(self, in_channels, out_channels, D):
        ...
        self.delayer1 = ME.MinkowskiLinear(256, out_channels, bias=False)
        self.delayer2 = ME.MinkowskiLinear(128, out_channels, bias=False)
        self.delayer3 = ME.MinkowskiLinear(64, out_channels, bias=False)
        self.delayer4 = ME.MinkowskiLinear(32, out_channels, bias=False)
